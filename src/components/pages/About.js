...
function About() {
  ...
  <p>
    Robert Campagna from Long Island, New York.  Father of twin boys Json and Mern.  Thats a nerd joke, my sons names are Oliver and Wesley.  Born to entertain with the love for baseball and hockey.  Cancer survivor.  I am competetive. I live life by this rule, "There are always two people for a job, you and the other guy.  F--K the other guy."
  </p>
  <div className="teams">
